feature 'viewing all the listings' do
  scenario 'a user can see all the spaces' do
    ...
    expect(page).to have_content('Makers Space, A beautiful space, 30, 2020-11-10, 2020-12-10, London')
  end
  ...
  scenario 'a user can see available spaces' do
    ...
    expect(page).to_not have_content('Makers Space, A beautiful space, 30, 2020-11-10, 2020-12-10, London')
    expect(page).to have_content('January Space, A beautiful new year space, 50, 2020-12-31, 2020-02-01, Reading')
  end
